...
class Weakness extends Item
{
    ...
    {
        parent::__construct('&cWeakness', VanillaItems::GUNPOWDER());
    }
        ...
        if ($event instanceof EntityDamageByEntityEvent) {
            ...
            if ($session !== null) {
                ...
                if ($cooldown !== null && !$cooldown->isExpired()) {
                    $player->sendMessage(TextFormat::colorize('&cTienes cooldown para usar esto item'));
                    return;
                }
            ...
            if ($data['count'] >= 1) {
                ...
                $effects->add(new EffectInstance(VanillaEffects::WEAKNESS(), 20 * 10, 3));
                ...
                $player->sendMessage(TextFormat::colorize('&eHas usado la ability ' . $this->getName() . PHP_EOL . '&eTienes un cooldown de: ' . gmdate('i:s' . $this->getTime())));
                return;
            }

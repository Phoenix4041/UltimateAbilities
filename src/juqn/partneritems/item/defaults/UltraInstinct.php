...
class UltraInstinct extends Item
{
    
    /**
     * UltraInstinct construct.
     */
    public function __construct()
    {
        parent::__construct('&gUltra Instinct', VanillaItems::DYE()->setColor(DyeColor::GRAY())); // Dont have dyecolorids
    }
    ...
    public function onClickAir(Player $player, Vector3 $directionVector): ItemUseResult
    {
        ...
        if ($result->equals(ItemUseResult::SUCCESS())) {
            ...
            $effects->add(new EffectInstance(VanillaEffects::SPEED(), 20 * 30, 3));
